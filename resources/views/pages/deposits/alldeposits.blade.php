@extends('layouts.app', ['activePage' => 'table', 'title' => 'UPRISE SACCO Deposit', 'navName' => 'All Deposits', 'activeButton' => 'laravel'])
                    ...
                    <div class="card strpied-tabled-with-hover" style="border: 1px solid #e0e0e0; box-shadow: 0px 0px 10px rgba(0,0,0,0.1);">
                        <div class="card-header" style="background-color: #f5f5f5;">
                            <div class="container mt-5">
                                ...
                                <!-- ... rest of the code ... -->
                                <p style="font-weight: bold; color:rgb(143, 49, 49); text-align: right;"> Total:UGX,{{number_format($totalAllAmount)}}</p>
